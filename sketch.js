...
function draw() { //這是一個繪圖函數，會一直執行
  ...
  // 更新題目和選項的位置
  question.position(windowWidth/2-90,windowHeight/2-120);
  option1.position(windowWidth/2-75,windowHeight/2-20);
  submitButton.position(windowWidth/2-35,windowHeight/2+10);
  result.position(windowWidth/2-55,windowHeight/2+70);
  answerInput.position(windowWidth/2-75,windowHeight/2-30);
}
